...
type V2ServiceProvider interface {
	...
	GetDelegationsByBabylonAddress(ctx context.Context, bbnAddress string, state types.DelegationState, paginationKey string) ([]*DelegationPublic, string, *types.Error)
	...
	GetStakingAPR(ctx context.Context, satoshisStaked, ubbnStaked int64) (*StakingAPRPublic, *types.Error)
	/*
