...
type V1DBClient interface {
	...
	FindDelegationByTxHashHex(ctx context.Context, txHashHex string) (*v1model.DelegationDocument, error)
	...
	GetOverallStats(ctx context.Context) (*v1model.OverallStatsDocument, error)
	...
	FindFinalityProviderStats(ctx context.Context, paginationToken string) (*db.DbResultMap[*v1model.FinalityProviderStatsDocument], error)
	...
	FindTopStakersByTvl(ctx context.Context, paginationToken string) (*db.DbResultMap[*v1model.StakerStatsDocument], error)
	...
	GetLatestBtcInfo(ctx context.Context) (*v1model.BtcInfo, error)
