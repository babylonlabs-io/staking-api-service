...
func (_m *V1DBClient) CheckDelegationExistByStakerPk(ctx context.Context, address string, extraFilter *v1db.DelegationFilter) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *v1db.DelegationFilter) (bool, error)); ok {
		return rf(ctx, address, extraFilter)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *v1db.DelegationFilter) bool); ok {
		r0 = rf(ctx, address, extraFilter)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, *v1db.DelegationFilter) error); ok {
...
func (_m *V1DBClient) FindDelegationByTxHashHex(ctx context.Context, txHashHex string) (*v1model.DelegationDocument, error) {
	...
	var r0 *v1model.DelegationDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*v1model.DelegationDocument, error)); ok {
		return rf(ctx, txHashHex)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *v1model.DelegationDocument); ok {
		r0 = rf(ctx, txHashHex)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1model.DelegationDocument)
		}
	}
...
func (_m *V1DBClient) FindDelegationsByStakerPk(ctx context.Context, stakerPk string, extraFilter *v1db.DelegationFilter, paginationToken string) (*db.DbResultMap[v1model.DelegationDocument], error) {
	...
	var r0 *db.DbResultMap[v1model.DelegationDocument]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, *v1db.DelegationFilter, string) (*db.DbResultMap[v1model.DelegationDocument], error)); ok {
		return rf(ctx, stakerPk, extraFilter, paginationToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, *v1db.DelegationFilter, string) *db.DbResultMap[v1model.DelegationDocument]); ok {
		r0 = rf(ctx, stakerPk, extraFilter, paginationToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*db.DbResultMap[v1model.DelegationDocument])
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, *v1db.DelegationFilter, string) error); ok {
...
func (_m *V1DBClient) FindFinalityProviderStats(ctx context.Context, paginationToken string) (*db.DbResultMap[*v1model.FinalityProviderStatsDocument], error) {
	...
	var r0 *db.DbResultMap[*v1model.FinalityProviderStatsDocument]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*db.DbResultMap[*v1model.FinalityProviderStatsDocument], error)); ok {
		return rf(ctx, paginationToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *db.DbResultMap[*v1model.FinalityProviderStatsDocument]); ok {
		r0 = rf(ctx, paginationToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*db.DbResultMap[*v1model.FinalityProviderStatsDocument])
		}
	}
...
func (_m *V1DBClient) FindFinalityProviderStatsByFinalityProviderPkHex(ctx context.Context, finalityProviderPkHex []string) ([]*v1model.FinalityProviderStatsDocument, error) {
	...
	var r0 []*v1model.FinalityProviderStatsDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]*v1model.FinalityProviderStatsDocument, error)); ok {
		return rf(ctx, finalityProviderPkHex)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string) []*v1model.FinalityProviderStatsDocument); ok {
		r0 = rf(ctx, finalityProviderPkHex)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v1model.FinalityProviderStatsDocument)
		}
	}
...
func (_m *V1DBClient) FindPkMappingsByNativeSegwitAddress(ctx context.Context, nativeSegwitAddresses []string) ([]*model.PkAddressMapping, error) {
...
func (_m *V1DBClient) FindPkMappingsByTaprootAddress(ctx context.Context, taprootAddresses []string) ([]*model.PkAddressMapping, error) {
...
func (_m *V1DBClient) FindTopStakersByTvl(ctx context.Context, paginationToken string) (*db.DbResultMap[*v1model.StakerStatsDocument], error) {
	ret := _m.Called(ctx, paginationToken)
	...
	var r0 *db.DbResultMap[*v1model.StakerStatsDocument]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*db.DbResultMap[*v1model.StakerStatsDocument], error)); ok {
		return rf(ctx, paginationToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *db.DbResultMap[*v1model.StakerStatsDocument]); ok {
		r0 = rf(ctx, paginationToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*db.DbResultMap[*v1model.StakerStatsDocument])
		}
	}
...
func (_m *V1DBClient) FindUnprocessableMessages(ctx context.Context) ([]model.UnprocessableMessageDocument, error) {
	ret := _m.Called(ctx)
...
func (_m *V1DBClient) GetLatestBtcInfo(ctx context.Context) (*v1model.BtcInfo, error) {
	ret := _m.Called(ctx)
	...
	var r0 *v1model.BtcInfo
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*v1model.BtcInfo, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *v1model.BtcInfo); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1model.BtcInfo)
		}
	}
...
func (_m *V1DBClient) GetOrCreateStatsLock(ctx context.Context, stakingTxHashHex string, state string) (*v1model.StatsLockDocument, error) {
	...
	var r0 *v1model.StatsLockDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*v1model.StatsLockDocument, error)); ok {
		return rf(ctx, stakingTxHashHex, state)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) *v1model.StatsLockDocument); ok {
		r0 = rf(ctx, stakingTxHashHex, state)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1model.StatsLockDocument)
		}
	}
...
func (_m *V1DBClient) GetOverallStats(ctx context.Context) (*v1model.OverallStatsDocument, error) {
	ret := _m.Called(ctx)
	...
	var r0 *v1model.OverallStatsDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*v1model.OverallStatsDocument, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *v1model.OverallStatsDocument); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1model.OverallStatsDocument)
		}
	}
...
func (_m *V1DBClient) GetStakerStats(ctx context.Context, stakerPkHex string) (*v1model.StakerStatsDocument, error) {
	...
	var r0 *v1model.StakerStatsDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*v1model.StakerStatsDocument, error)); ok {
		return rf(ctx, stakerPkHex)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *v1model.StakerStatsDocument); ok {
		r0 = rf(ctx, stakerPkHex)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1model.StakerStatsDocument)
		}
	}
...
func (_m *V1DBClient) ScanDelegationsPaginated(ctx context.Context, paginationToken string) (*db.DbResultMap[v1model.DelegationDocument], error) {
	ret := _m.Called(ctx, paginationToken)
	...
	var r0 *db.DbResultMap[v1model.DelegationDocument]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*db.DbResultMap[v1model.DelegationDocument], error)); ok {
		return rf(ctx, paginationToken)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *db.DbResultMap[v1model.DelegationDocument]); ok {
		r0 = rf(ctx, paginationToken)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*db.DbResultMap[v1model.DelegationDocument])
