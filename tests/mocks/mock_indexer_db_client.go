...
func (_m *IndexerDBClient) GetFinalityProviderStats(ctx context.Context, fpPkHexes []string) ([]*indexerdbmodel.IndexerFinalityProviderStatsDocument, error) {
	...
	var r0 []*indexerdbmodel.IndexerFinalityProviderStatsDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]*indexerdbmodel.IndexerFinalityProviderStatsDocument, error)); ok {
		return rf(ctx, fpPkHexes)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string) []*indexerdbmodel.IndexerFinalityProviderStatsDocument); ok {
		r0 = rf(ctx, fpPkHexes)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*indexerdbmodel.IndexerFinalityProviderStatsDocument)
		}
	}
...
func (_m *IndexerDBClient) GetOverallStats(ctx context.Context) (*indexerdbmodel.IndexerStatsDocument, error) {
	ret := _m.Called(ctx)
	...
	var r0 *indexerdbmodel.IndexerStatsDocument
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (*indexerdbmodel.IndexerStatsDocument, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) *indexerdbmodel.IndexerStatsDocument); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*indexerdbmodel.IndexerStatsDocument)
		}
	}
