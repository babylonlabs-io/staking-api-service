...
func (_m *DBClient) SaveTermsAcceptance(ctx context.Context, termsAcceptance *model.TermsAcceptance) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.TermsAcceptance) error); ok {
