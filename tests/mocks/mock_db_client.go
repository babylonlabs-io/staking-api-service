...
func (_m *DBClient) LocksCollection() *mongo.Collection {
	ret := _m.Called()
...
func (_m *DBClient) SaveTermsAcceptance(ctx context.Context, termsAcceptance *dbmodel.TermsAcceptance) error {
